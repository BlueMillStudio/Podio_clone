...
exports.completeProfile = async (req, res) => {
  ...
  try {
    ...
    const defaultApps = [
      {
        name: "Activity",
        fields: [{ name: "Title", field_type: "text", is_required: true }],
      },
      {
        name: "Leads & Clients",
        fields: [
      ...
      },
      {
        name: "Projects",
        fields: [
          { name: "Project Name", field_type: "text", is_required: true },
        ],
      },
      {
        name: "Inspiration",
        fields: [{ name: "Idea", field_type: "text", is_required: true }],
      },
      {
        name: "Meetings",
        fields: [
          { name: "Meeting Date", field_type: "date", is_required: true },
        ],
      },
      {
        name: "Expenses",
        fields: [{ name: "Amount", field_type: "number", is_required: true }],
      },
    ];
